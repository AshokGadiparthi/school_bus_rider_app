...
class _SearchScreenState extends State<SearchScreen>
{
  ...
  void findPlace(String placeName) async
  {
    ...
    {
      Uri autoCompleteUrl = Uri.parse("https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=$mapKey&sessiontoken=1234567890&components=country:us");
...
class PredictionTile extends StatelessWidget
{
  ...
  Widget build(BuildContext context)
  {
    return TextButton(
      style: TextButton.styleFrom(
        padding: EdgeInsets.all(0.0), // Button padding
      ),
      onPressed: () {
  ...
  void getPlaceAddressDetails(String? placeId, context) async{
    ...
    Uri placeDetailsUrl = Uri.parse("https://maps.googleapis.com/maps/api/place/details/json?place_id=$placeId&key=$mapKey");
